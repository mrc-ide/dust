...
sir <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL, device = FALSE) {
      dust_sir_filter(private$ptr_, save_trajectories, step_snapshot, device)
    },
...
variable <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL, device = FALSE) {
      dust_variable_filter(private$ptr_, save_trajectories, step_snapshot, device)
    },
...
volatility <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL, device = FALSE) {
      dust_volatility_filter(private$ptr_, save_trajectories, step_snapshot, device)
    },
...
walk <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL, device = FALSE) {
      dust_walk_filter(private$ptr_, save_trajectories, step_snapshot, device)
    },
