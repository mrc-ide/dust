...
sir <- R6::R6Class(
  ...
  public = list(
    ...
    rng_state = function(advance) {
      dust_sir_rng_state(private$ptr_, advance)
    }
  ))
variable <- R6::R6Class(
  "dust",
  ...
  public = list(
    ...
    rng_state = function(advance) {
      dust_variable_rng_state(private$ptr_, advance)
    }
  ))
volatility <- R6::R6Class(
  ...
  public = list(
    ...
    rng_state = function(advance) {
      dust_volatility_rng_state(private$ptr_, advance)
    }
  ))
walk <- R6::R6Class(
  "dust",
  ...
  public = list(
    ...
    rng_state = function(advance) {
      dust_walk_rng_state(private$ptr_, advance)
    }
  ))
