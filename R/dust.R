## Generated by dust (version 0.8.11) - do not edit
sir <- R6::R6Class(
  "dust",
  cloneable = FALSE,
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL) {
      dust_sir_filter(private$ptr_, save_trajectories, step_snapshot)
    },
...
variable <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL) {
      dust_variable_filter(private$ptr_, save_trajectories, step_snapshot)
    },
...
volatility <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL) {
      dust_volatility_filter(private$ptr_, save_trajectories, step_snapshot)
    },
...
walk <- R6::R6Class(
  ...
  public = list(
    ...
    filter = function(save_trajectories = FALSE, step_snapshot = NULL) {
      dust_walk_filter(private$ptr_, save_trajectories, step_snapshot)
    },
