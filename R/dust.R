...
sir <- R6::R6Class(
  ...
  private = list(
    ...
    check_data_multi = function(data, len) {
      ...
      if (n == 0 && length(data) == 0) {
        stop("Expected 'data' to have at least one element")
      } else if (n > 0 && length(data) != n) {
        stop(sprintf("Expected 'data' to have %d elements", n))
      }
    }
  ),
  ...
  public = list(
    initialize = function(data, step, n_particles, n_threads = 1L,
      ...
      if (data_multi) {
        private$check_data_multi(data)
      }
      res <- dust_sir_alloc(data, data_multi, step, n_particles,
                        n_threads, seed)
      private$data_ <- data
      private$data_multi_ <- data_multi
...
variable <- R6::R6Class(
  ...
  public = list(
    initialize = function(data, step, n_particles, n_threads = 1L,
      ...
      res <- dust_variable_alloc(data, data_multi, step, n_particles,
                        n_threads, seed)
      private$data_ <- data
      private$data_multi_ <- data_multi
      private$n_threads_ <- n_threads
...
volatility <- R6::R6Class(
  ...
  public = list(
    initialize = function(data, step, n_particles, n_threads = 1L,
      ...
      res <- dust_volatility_alloc(data, data_multi, step, n_particles,
                        n_threads, seed)
      private$data_ <- data
      private$data_multi_ <- data_multi
      private$n_threads_ <- n_threads
...
walk <- R6::R6Class(
  ...
  public = list(
    initialize = function(data, step, n_particles, n_threads = 1L,
      ...
      res <- dust_walk_alloc(data, data_multi, step, n_particles,
                        n_threads, seed)
      private$data_ <- data
      private$data_multi_ <- data_multi
      private$n_threads_ <- n_threads
