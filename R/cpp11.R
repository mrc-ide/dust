...
dust_cpu_sir_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_cpu_sir_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_cpu_sirs_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_cpu_sirs_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_gpu_sirs_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_gpu_sirs_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_cpu_variable_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_cpu_variable_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_gpu_variable_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_gpu_variable_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_cpu_volatility_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_cpu_volatility_filter`, ptr, step, save_trajectories, step_snapshot)
}
...
dust_cpu_walk_filter <- function(ptr, step, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_cpu_walk_filter`, ptr, step, save_trajectories, step_snapshot)
}
