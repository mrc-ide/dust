...
dust_sirs_run <- function(ptr, step_end) {
  .Call(`_dust_dust_sirs_run`, ptr, step_end)
}
...
dust_sirs_filter <- function(ptr, save_trajectories, step_snapshot) {
  .Call(`_dust_dust_sirs_filter`, ptr, save_trajectories, step_snapshot)
}
