...
dust_sir2_alloc <- function(r_pars, pars_multi, step, n_particles, n_threads, r_seed) {
  .Call(`_dust_dust_sir2_alloc`, r_pars, pars_multi, step, n_particles, n_threads, r_seed)
}

dust_sir2_run <- function(ptr, step_end) {
  .Call(`_dust_dust_sir2_run`, ptr, step_end)
}

dust_sir2_set_index <- function(ptr, r_index) {
  .Call(`_dust_dust_sir2_set_index`, ptr, r_index)
}

dust_sir2_set_state <- function(ptr, r_state, r_step) {
  .Call(`_dust_dust_sir2_set_state`, ptr, r_state, r_step)
}

dust_sir2_reset <- function(ptr, r_pars, step) {
  .Call(`_dust_dust_sir2_reset`, ptr, r_pars, step)
}

dust_sir2_state <- function(ptr, r_index) {
  .Call(`_dust_dust_sir2_state`, ptr, r_index)
}

dust_sir2_step <- function(ptr) {
  .Call(`_dust_dust_sir2_step`, ptr)
}

dust_sir2_reorder <- function(ptr, r_index) {
  invisible(.Call(`_dust_dust_sir2_reorder`, ptr, r_index))
}

dust_sir2_resample <- function(ptr, r_weights) {
  .Call(`_dust_dust_sir2_resample`, ptr, r_weights)
}

dust_sir2_set_pars <- function(ptr, r_pars) {
  .Call(`_dust_dust_sir2_set_pars`, ptr, r_pars)
}

dust_sir2_rng_state <- function(ptr, first_only) {
  .Call(`_dust_dust_sir2_rng_state`, ptr, first_only)
}

dust_sir2_set_rng_state <- function(ptr, rng_state) {
  .Call(`_dust_dust_sir2_set_rng_state`, ptr, rng_state)
}

dust_sir2_set_data <- function(ptr, data) {
  .Call(`_dust_dust_sir2_set_data`, ptr, data)
}

dust_sir2_compare_data <- function(ptr) {
  .Call(`_dust_dust_sir2_compare_data`, ptr)
}

dust_sir2_filter <- function(ptr, save_history) {
  .Call(`_dust_dust_sir2_filter`, ptr, save_history)
}

dust_sir2_simulate <- function(r_steps, r_pars, r_state, r_index, n_threads, r_seed, return_state) {
  .Call(`_dust_dust_sir2_simulate`, r_steps, r_pars, r_state, r_index, n_threads, r_seed, return_state)
}

dust_sir2_capabilities <- function() {
  .Call(`_dust_dust_sir2_capabilities`)
}

dust_sir2_set_n_threads <- function(ptr, n_threads) {
  invisible(.Call(`_dust_dust_sir2_set_n_threads`, ptr, n_threads))
}

dust_sir2_n_state <- function(ptr) {
  .Call(`_dust_dust_sir2_n_state`, ptr)
}
