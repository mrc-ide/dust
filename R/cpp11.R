...
test_cuda_pars <- function(device_id, n_particles, n_particles_each, n_state, n_state_full, n_shared_int, n_shared_real, data_size, shared_size, run_block_size) {
  .Call(`_dust_test_cuda_pars`, device_id, n_particles, n_particles_each, n_state, n_state_full, n_shared_int, n_shared_real, data_size, shared_size, run_block_size)
}
