...
dust_sir_set_data <- function(ptr, r_data) {
  .Call("_dust_dust_sir_set_data", ptr, r_data)
}
...
dust_variable_set_data <- function(ptr, r_data) {
  .Call("_dust_dust_variable_set_data", ptr, r_data)
}
...
dust_volatility_set_data <- function(ptr, r_data) {
  .Call("_dust_dust_volatility_set_data", ptr, r_data)
}
...
dust_walk_set_data <- function(ptr, r_data) {
  .Call("_dust_dust_walk_set_data", ptr, r_data)
}
