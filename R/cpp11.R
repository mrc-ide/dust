...
dust_sir_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_dust_dust_sir_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed, PACKAGE = "dust")
}
...
dust_variable_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_dust_dust_variable_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed, PACKAGE = "dust")
}
...
dust_volatility_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_dust_dust_volatility_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed, PACKAGE = "dust")
}
...
dust_walk_simulate <- function(r_steps, r_data, r_state, r_index, n_threads, r_seed) {
  .Call("_dust_dust_walk_simulate", r_steps, r_data, r_state, r_index, n_threads, r_seed, PACKAGE = "dust")
}
