...
A particle state is determined by three mutable things; `pars`, `state` and `step`; these can all be updated for a model after it has been created.  We have found setting one or more of these at a time important;
