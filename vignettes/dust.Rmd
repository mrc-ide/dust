...
You can optionally set the initial step at the same time as the state. This is useful if your model depends on time (e.g., you use the step in a calculation by transforming it into some measure of time).
