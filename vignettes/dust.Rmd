...
* the constructor must take only one argument, being `const init_t&`. You can do what you want in the constructor - here we just copy the parameters into the object with the `pars` argument (we use the private member `pars_` here but this can be anything you want)
