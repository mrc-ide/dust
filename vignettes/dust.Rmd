...
* the type `rng_state_type` is one of the valid RNG types. Typically `typedef dust::random::generator<real_type> rng_state_type;` will select a reasonable choice, but you could also force a specific generator such as `dust::random::xoshiro256starstar` here (see `vignette("rng")`)
