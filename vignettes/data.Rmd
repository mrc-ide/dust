...
* describing the types of the observed data at each time point in a C++ struct (here it will be a single numeric value, but the data could be arbitrarily complicated)
