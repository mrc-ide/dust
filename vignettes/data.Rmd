...
* describing the data (here it will be a single numeric value, but the data could be arbitrarily complicated)
* implementing a method to do the comparison
* describe how to marshal the data into this structure
