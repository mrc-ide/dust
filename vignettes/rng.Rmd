...
```cc
real_type u = rng.uniform<real_type>(3, 6);
```
...
```cc
real_type z = rng.normal<real_type>(3, 6);
```
...
```cc
int n = rng.poisson<real_type>(4.5);
```
...
```cc
int n = rng.binomial<real_type>(10, 0.3);
```
