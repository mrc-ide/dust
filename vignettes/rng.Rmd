...
We include 12 different algoithms for creating the underlying random integer, from the [same family of generators](https://prng.di.unimi.it/).  These provide different undering storage types (either 32 bit or 64 bit integers) and different state types.
...
Our random number library can be reused in other projects without using anything else from dust; either in an R package or in a standlone project.
