...
dust provides support for simulating lots of particles at once. But sometimes we want to structure these simulations in some way.
...
This sort of shape is useful where we want to fit multiple particle filters to the data, or simulate replicates blocked across a common set of parameters. But there are other way of shaping the state that are useful.
