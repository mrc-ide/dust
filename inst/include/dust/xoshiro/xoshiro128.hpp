...
template <>
constexpr std::array<uint32_t, 4> jump_constants<uint32_t, 4>() {
...
template <>
constexpr std::array<uint32_t, 4> long_jump_constants<uint32_t, 4>() {
  return std::array<uint32_t, 4>{
    0xb523952e, 0x0b6f099f, 0xccf5a0ef, 0x1c580662 };
}

template <>
inline HOSTDEVICE uint32_t rng_next(xoshiro128starstar_state& state) {
...
template <>
inline HOSTDEVICE uint32_t rng_next(xoshiro128plusplus_state& state) {
...
template <>
inline HOSTDEVICE uint32_t rng_next(xoshiro128plus_state& state) {
