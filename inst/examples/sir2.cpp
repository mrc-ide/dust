...
public:
  ...
  sir2(const dust::pars_t<sir2>& pars) : shared(pars.shared) {
  }
...
template <>
dust::pars_t<sir2> dust_pars<sir2>(cpp11::list pars) {
  ...
  sir2::shared_t shared{S0, I0, R0, beta, gamma, dt, freq, exp_noise};
  return dust::pars_t<sir2>(shared);
}
