...
SEXP dust_volatility_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                         cpp11::sexp r_n_particles, size_t n_threads,
                         cpp11::sexp r_seed, cpp11::sexp device_id) {
  return dust_alloc<volatility>(r_pars, pars_multi, step, r_n_particles,
                               n_threads, r_seed, device_id);
}

SEXP dust_volatility_run(SEXP ptr, size_t step_end, bool device) {
  return dust_run<volatility>(ptr, step_end, device);
}
...
SEXP dust_volatility_filter(SEXP ptr, bool save_trajectories,
                          cpp11::sexp step_snapshot) {
  return dust_filter<volatility>(ptr, save_trajectories, step_snapshot);
}
...
cpp11::sexp dust_volatility_device_info() {
  return dust_device_info<volatility>();
}
