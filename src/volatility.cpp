...
[[cpp11::register]]
SEXP dust_cpu_volatility_alloc(cpp11::list r_pars, bool pars_multi, size_t time,
...
SEXP dust_cpu_volatility_alloc(cpp11::list r_pars, bool pars_multi, size_t time,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<volatility>(r_pars, pars_multi, time, r_n_particles,
