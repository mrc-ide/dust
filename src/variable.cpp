// Generated by dust (version 0.9.14) - do not edit
#include <cpp11.hpp>
[[cpp11::register]]
...
SEXP dust_variable_run(SEXP ptr, size_t step_end, bool device,
                       bool deterministic) {
  return dust::r::dust_run<variable>(ptr, step_end, device, deterministic);
}
...
SEXP dust_variable_set_state(SEXP ptr, SEXP r_state, SEXP r_step,
                             bool deterministic) {
  dust::r::dust_set_state<variable>(ptr, r_state, r_step, deterministic);
  return R_NilValue;
}
